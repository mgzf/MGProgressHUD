...
extension MGProgressHUD {
    ...
    /**
     ...
     - returns: <#return value description#>
     */
    class func  showMessageView(toView:UIView!,message:String?)->MGProgressHUD?{
    ...
    /**
     ...
     - returns: <#return value description#>
     */
    class func  showLoadingView(toView:UIView!,message:String?)->MGProgressHUD?{
        var arr  = [String]()
        for index in 1..<10 {
    ...
    /**
     ...
     - returns: <#return value description#>
     */
    class func  showProgressLoadingView(toView:UIView!,message:String?)->MGProgressHUD?{
    ...
    /**
     ...
     - returns: <#return value description#>
     */
    class func  showTextAndHiddenView(toView:UIView!,message:String?)->MGProgressHUD?{
        if message?.characters.count > 0 {
            let progressView = showView(toView, icons: nil, message: message, messageColor: nil, showBgView: false, detailText: nil, detailColor: nil, loationMode: nil)
            progressView?.contentView.backgroundColor = UIColor.blackColor().colorWithAlphaComponent(0.65)
            progressView?.labelColor = UIColor.whiteColor()
    ...
    /**
     ...
     - returns: <#return value description#>
     */
    class func  showTextAndHiddenView(toView:UIView!,message:String?,loationMode:MGLocationMode?)->MGProgressHUD?{
        if message?.characters.count > 0 {
    ...
    /*! 扩展方法 */
    class func  showFillView(toView:UIView!,
                               icon:String?,
                            message:String?,
                         detailText:String?) ->MGProgressHUD? {
    ...
    class func showTextAndHiddenView(message:String?)->MGProgressHUD? {
        if message?.characters.count > 0 {
    ...
    class func hiddenHUD(animated:Bool)->Int{
        var count = 0
    ...
    class func showSuccessAndHiddenView(toView:UIView!,
                                        icon:String?,
                                        message:String?,
                                        detailText:String?) ->MGProgressHUD? {
        var icons = [String]()
    ...
    class func  showSuccessAndHiddenView(toView:UIView!,message:String?)->MGProgressHUD?{
        return self.showSuccessAndHiddenView(toView, icon: "ic_whiteCheck", message: message, detailText: nil)
    }
    
    class func  showSuccessAndHiddenView(message:String?)->MGProgressHUD?{

        return self.showSuccessAndHiddenView(lastShowWindow(), icon: "ic_whiteCheck", message: message, detailText: nil)
    }
    
    class func  showErrorAndHiddenView(toView:UIView!,message:String?)->MGProgressHUD?{
        return self.showSuccessAndHiddenView(toView, icon: "error", message: message, detailText: nil)
    }
    
    class func  showErrorAndHiddenView(message:String?)->MGProgressHUD?{
